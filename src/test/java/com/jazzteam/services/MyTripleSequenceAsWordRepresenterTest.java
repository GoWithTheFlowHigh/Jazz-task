...
public class MyTripleSequenceAsWordRepresenterTest {
    static private TripleSequenceAsWordRepresenter tripleSequenceAsWordRepresenter;
    ...
    static void initTripleSequenceAsWordsRepresenter() {
        tripleSequenceAsWordRepresenter = new MyTripleSequenceAsWordRepresenterBuilder().getResult();
    }

    static void initTripleSequenceFactory() {
        tripleSequenceFactory = new MyTripleSequenceFactoryBuilder().getResult();
    }
    ...
    void wordsRepresentationOfTripleSequence(String numberAsStringOfDigits, String expectedWordsRepresentation) {
        ...
        assertEquals(expectedWordsRepresentation,
                     tripleSequenceAsWordRepresenter.transcript(tripleSequence));
    }
}
